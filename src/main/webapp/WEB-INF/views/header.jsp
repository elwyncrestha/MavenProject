            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="messagesDropdown">
                    ...
                    <a class="dropdown-item" href="#">
                        <strong>${ContactDetails.get(0).name}</strong>
                        <span class="small float-right text-muted">11:21 AM</span>
                        <div class="dropdown-message small">${ContactDetails.get(0).message}</div>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#">
                        <strong>${ContactDetails.get(1).name}</strong>
                        <span class="small float-right text-muted">11:21 AM</span>
                        <div class="dropdown-message small">${ContactDetails.get(1).message}</div>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item small" href="${pageContext.request.contextPath}/admin/message/display">View all messages</a>
                </div>
            </li>
            <li class="nav-item dropdown">
